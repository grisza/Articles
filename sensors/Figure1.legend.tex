\begin{tikzpicture}[scale=0.2]	
	\node[draw=black,thick,rounded corners=2pt,below left=2mm] {%
		\begin{tabular}{@{}r@{ }l@{}}
			...
			\raisebox{2pt}{\tikz{\draw[black,pattern=horizontal lines, pattern color = black] (0,0) rectangle (5mm,2mm);}} & Too far               \\
			\raisebox{2pt}{\tikz{\draw[black, fill=white] (0,0) rectangle (5mm,2mm);}}                                     & Too close             \\
			\raisebox{2pt}{\tikz{\draw[black,pattern=dots, pattern color = black] (0,0) rectangle (5mm,2mm);}}             & Wrokspace             \\
